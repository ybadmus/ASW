...
const TopBar = ({ className, dark }) => {
    ...
    useEffect(() => {
        ...
        fetchData("https://admin.aswnews.com/api/v1/posts/trending").then(trending => {
    ...
    return ( <
        ...
        onClick = { goPrev } > < FontAwesome name = "angle-left" / >
        <
        /button> <
        button className = "navBtn nextBtn"
        onClick = { goNext } > < FontAwesome name = "angle-right" / >
        <
        /button> <
        /div> <
        /div> <
